            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="p-lg-5 p-4">
                        ...
                        <form class="user" id="guaranteeCreate" method="POST" enctype="multipart/form-data" action="{{ route('guaranteeStore') }}">
                        @csrf
                            <div class="form-group row">
                                <div class="col-sm-12 mb-3 ">
                                    ...
                                    <select class="form-control form_input" name="guarantee_type" id="guarantee_type">
                                        ...
                                        <option value="Bank">Bid Bond</option>
                                ...
                                <div class="col-sm-12 mb-3 ">
                                    ...
                                    <input type="number" name="nominal_amount" class="form-control form_input" id="nominal_amount " placeholder="Nominal Amount">
                                </div>

                                <div class="col-sm-12 mb-3 ">
                                    <label for="nominal_amount_currency" class="text-dark">Nominal Amount Currency <span class="text-danger">*</span></label>
                                    <input type="text" name="nominal_amount_currency" class="form-control form_input" id="nominal_amount_currency " placeholder="Nominal Amount Currency">
                                </div>

                                <div class="col-sm-12 mb-3 ">
                                    <label for="expiry_date" class="text-dark">Expiry Date <span class="text-danger">*</span></label>
                                    <input type="date" name="expiry_date" class="form-control form_input" id="expiry_date" placeholder="Expiry Date">
                                </div>

                                <div class="col-sm-12 mb-3 ">
                                    <label for="applicant_name" class="text-dark">Applicant Name <span class="text-danger">*</span></label>
                                    <input type="text" name="applicant_name" class="form-control form_input" id="applicant_name" placeholder="Applicant Name">
                                </div>

                                <div class="col-sm-12 mb-3 ">
                                    <label for="applicant_address" class="text-dark">Applicant Address <span class="text-danger">*</span></label>
                                    <input type="text" name="applicant_address" class="form-control form_input" id="applicant_address" placeholder="Applicant Address">
                                </div>

                                <div class="col-sm-12 mb-3 ">
                                    <label for="beneficiary_name" class="text-dark">Beneficiary Name <span class="text-danger">*</span></label>
                                    <input type="text" name="beneficiary_name" class="form-control form_input" id="beneficiary_name" placeholder="Beneficiary Name">
                                </div>

                                <div class="col-sm-12 mb-3 ">
                                    <label for="beneficiary_address" class="text-dark">Beneficiary Address <span class="text-danger">*</span></label>
                                    <input type="text" name="beneficiary_address" class="form-control form_input" id="beneficiary_address" placeholder="Beneficiary Name">
                                </div>
...
{!! JsValidator::formRequest('App\Http\Requests\AddGuranteeRequest','#guaranteeCreate') !!}
